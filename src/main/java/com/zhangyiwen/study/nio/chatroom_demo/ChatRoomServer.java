package com.zhangyiwen.study.nio.chatroom_demo;
...
public class ChatRoomServer {
    ...
    private static String USER_CONTENT_SPILIT = "#@#";    //相当于自定义协议格式，与客户端协商好
    ...
    public void dealWithSelectionKey(ServerSocketChannel server,SelectionKey sk) throws IOException {
        ...
        if(sk.isReadable())
        {
            ...
            try
            {
                ...
                System.out.println("[Server listening from client] -> client:" + sc.getRemoteAddress() + ", data: " + content);
